...
const generarToken=(
    ...
    return jwt.sign({id,email,rol},process.env.JWT_SECRET,{expiresIn:'24h'});//Generamos el token basado en id de usuario y el email y este tiene su utilidad hasta las 24 horas
}
