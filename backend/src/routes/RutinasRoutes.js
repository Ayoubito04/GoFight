...
router.get('/obtener_ejercicios/:id',authMiddleware,RutinasController.ObtenerRutinaPorId);//Definimos la ruta para obtener los ejercicios de una rutina,para eso necesitamos el id de la rutina,que se lo pasamos como parametro a la función del controlador
